...
class Parser
  ...
  def self.perform(fight_id, report_id)
    ...
    bm_ids.each do |bm_id, bm_hash|
      ...
      fight_parses[bm_id] = FightParse.create(fight_id: fight.id, user_id: user_id, fight_hash: fight.fight_hash, player_id: bm_hash[:guid], boss_id: fight.boss_id, difficulty: fight.difficulty)
